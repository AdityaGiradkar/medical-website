<?php 
    ...
    if(isset($_SESSION['user_id'])){
      if($_SESSION['role'] == 'doctor'){
        $review_id = $_GET['id'];
        $get_review = "SELECT * FROM `review` WHERE `review_id`='$review_id'";
        $get_review_run = mysqli_query($con, $get_review);
        $result = mysqli_fetch_assoc($get_review_run);
      ...
      <li class="nav-item active">
        ...
        <div id="collapseReview" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="all_reviews.php">All Reviews</a>
        ...
        <div class="container-fluid main-top main-left">
          ...
          <form method="post" enctype="multipart/form-data">
            <div class="row pt-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $result['person_name']; ?>" id="rewiewer_name" name="rewiewer_name" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="rewiewer_designation">Reviewer Designation</label>
                        <input type="text" class="form-control" value="<?php echo $result['designation']; ?>" id="rewiewer_designation" name="rewiewer_designation" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                rows="3"><?php echo $result['review']; ?></textarea>
            </div>
              
            <div class="form-group mt-3">
              <label for="">Current Cover Photo</label><br>
              <img src="img/reviewer_image/<?php echo $result['photo']; ?>" width="200" /><br><br>
              <label for="cover_image">Select New</label>
              <input type="file" class="form-control-file " id="cover_image" name="cover_image">
            </div>
            <button type="submit" name="add_blog" class="btn btn-primary mt-3">Update Review</button>
          </form>
        ...
        if($_FILES['cover_image']['size'] != 0){
            ...
            if(in_array($file_ext, $valid_ext)){
                if($file_error === 0){
                    ...
                    $update = "UPDATE `review` SET `person_name`='$rewiewer_name', `designation`='$rewiewer_designation', `review`='$review', `photo`='$file_new_name' WHERE `review_id`='$review_id'";
            ...
            $update = "UPDATE `review` SET `person_name`='$rewiewer_name', `designation`='$rewiewer_designation', `review`='$review' WHERE `review_id`='$review_id'";
            if($update_run = mysqli_query($con, $update)) {
                echo "<script>
                            alert('update Sucessfull');
                            window.location.href='all_reviews.php';
