<?php 
    ...
    $result = mysqli_fetch_assoc($get_medicine_run);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid main-top main-left">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="name" rows="3"><?php echo $result['Name']; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Dose : </label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="dose" rows="3"><?php echo $result['dose']; ?></textarea>
                </div>
