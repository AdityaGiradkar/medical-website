    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid main-top main-left">
          ...
          ?>
          <div class="border border-primary  rounded-lg mt-4 p-3" style="background-color:#fdfdfd !important">
            <h1 class="h4 mb-2 text-gray-800">Submitted YOG-E @CritiCare Daily Test</h1>
            <p>submitted on: <b><?php echo date("d-m-Y", strtotime($record['created_at'])); ?></b></p>
            <p class="text-right">Report No : <b>CCDT<?php echo $test_details_res['criticare_test_no']; ?></b></p>
            ...
            <table class="table table-bordered table-striped table-responsive-md" id="treatBlock">
              ...
              <tbody>
                <tr>
                  ...
                  <td colspan="3"><?php echo $test_details_res['hospital_name']; ?></td>
                </tr>
                <tr>
                  <th scope="row">2</th>
                  <td>COVID-19 Testing Done</td>
                  <td></td>
                  <td><?php echo $test_details_res['covid_test']; ?></td>
                </tr>
                <tr>
                  <th scope="row">3</th>
                  <td>COVID-19 Test Rrport</td>
                  <td></td>
                  <td><?php echo $test_details_res['covid_report']; ?></td>
                </tr>
                <tr>
                  <th scope="row">4</th>
                  <td>Diagnosis as written on hospital/prescription paper</td>
                  <td></td>
                  <td><?php echo $test_details_res['prescription_paper']; ?></td>
                </tr>
                ...
                <tr style="color:<?php if($test_details_res['polymorphs']/100 < 40 || $test_details_res['polymorphs']/100 > 80){ echo 'red'; }?>">
                  ...
                  <td><?php if($test_details_res['polymorphs']/100 < 40 || $test_details_res['polymorphs']/100 > 80){ echo 'Alert'; }?></td>
                </tr>
            ...
            <p>Other complaints : <strong><?php echo $test_details_res['other_complaint']; ?></strong></p>
