  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion fixed-top" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseReview" aria-expanded="true"
          aria-controls="collapseTwo">
          <i class="fas fa-fw fa-pills"></i>
          <span>User Reviews</span>
        </a>
        <div id="collapseReview" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Reviews:</h6>
            <a class="collapse-item" href="all_reviews.php">All Reviews</a>
            <a class="collapse-item active" href="add_review.php">Add Review</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid main-top main-left">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Review</h1>
          ...
          <form method="post" enctype="multipart/form-data">
            <div class="row pt-3">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="rewiewer_name">Reviewer Name</label>
                        <input type="text" class="form-control" id="rewiewer_name" name="rewiewer_name" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="rewiewer_designation">Reviewer Designation</label>
                        <input type="text" class="form-control" id="rewiewer_designation" name="rewiewer_designation" required>
                    </div>
                </div>
            </div>
            
            <div class="form-group">
                <label for="review">Review (Write review in 250-300 charecter): <b id="counted_word">0</b>/300</label>
                <textarea class="form-control" id="review" name="review" rows="3" onkeyup="countChars(this);" MaxLength="300"></textarea>
            </div>
            ...
            <div class="form-group mt-3">
              ...
              <img id="preview" class="mt-3" width="100">
            </div>
            <button type="submit" name="add_blog" class="btn btn-primary mt-3">Add Review</button>
          </form>
...
<!-- word counter -->
  <script>
    function countChars(obj){
        document.getElementById("counted_word").innerHTML = obj.value.length;
    }
...
<?php
      ...
      include("small_scripts/resize_image.php");

      if(isset($_POST['add_blog'])){
          $rewiewer_name = mysqli_real_escape_string($con, $_POST['rewiewer_name']);
          $rewiewer_designation = mysqli_real_escape_string($con, $_POST['rewiewer_designation']);
          $review = mysqli_real_escape_string($con, $_POST['review']);
          $file = $_FILES['image'];
          
          $file_original = $_FILES['image']['name'];
          ...
          if(in_array($file_ext, $valid_ext)){
              if($file_error === 0){
                  ...
                  $file_destination = "img/reviewer_image/".$file_new_name;

                  $compressed_image = resize(500, 500, $file_destination);
                  ...
                  $update = "INSERT INTO `review`(`person_name`, `designation`, `review`, `photo`, `date`) 
                            VALUES ('$rewiewer_name', '$rewiewer_designation', '$review', '$file_new_name', '$date_time_store')";
                  if($update_run = mysqli_query($con, $update)) {
                      echo "<script>
                                  alert('New Review added sucessfully');
