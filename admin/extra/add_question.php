        ...
        <div class="container-fluid main-top main-left">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="que" rows="3"></textarea>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Option 1 : </label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="o1" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Option 2 : </label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="o2" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="o3" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Option 4 : </label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="o4" rows="3"></textarea>
                        </div>
                    </div>
                </div>
