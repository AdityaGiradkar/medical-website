      ...
      <li class="nav-item active">
        ...
        <div id="collapseMedicine" class="collapse show" aria-labelledby="headingTwo"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="add_medicine.php">Add Session</a>
            </div>
        </div>
    </li>
...
<?php
    if(isset($_POST['add'])){
        ...
        $add_session = "INSERT INTO `sessions`(`session_name`, `quantity`, `price`) VALUES ('$name','$quantity','$price')";
        if($add_session_run = mysqli_query($con, $add_session)) {
            echo "<script>
                        alert('New Session added Sucessfull');
                        window.location.href='add_session.php';
                    </script>";
        }
