            ...
            <div class="user_details  mr-3 ml-4">
                <div class="row">
                    <div class="col-6">
                        ...
                        <p>Test Name : <strong>YOG-E @Rakshakavach Test <?php if($record['test_type'] == 1) { echo 'Basic'; }else if($record['test_type'] == 5){ echo 'Advanced'; }?> Report</strong></p>
                    </div>
                    <div class="col-6">
...
<?php 
            }else{ //else part of if test is not checked
                echo "<script>
                        alert('undefind index');
